...
def main(myArgs):
    ...
    serverUrl2 = "/api/appliance/" + nodeId + "/usageaudit"
...
def helper():
    subprocess.call('clear', shell=True)
    print '''
This script gets audit data for a particular node 


Usage: 
    ./node-audit.py -b <serverName-or-ipAddr> -i <node-id> 


Example: 
    ./node-audit.py -b dorkcloud.com -i 14 
